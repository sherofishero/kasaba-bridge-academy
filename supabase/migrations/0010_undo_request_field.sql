-- ============================================================================
-- KASABA BRIDGE HUB — Migration 0010
-- publish_game_state: undoRequest alanını beyaz listeye ekle
--
-- KAPSAM:
--   Kart oynama aşamasında (açılış atağı dahil) undo talebi TableState'e
--   `undoRequest` alanı olarak eklenmiştir. Çok oyunculu masada
--   senkronize olabilmesi için publish_game_state RPC'sinin v_allowed
--   dizisine eklenmesi gerekir.
--
--   0009'un idempotent yeniden yayımıdır; mevcut alanlar korunur.
